...
namespace ENGINE
{
	...
	//static void SET_NON_CONTACT_ENTITY(Player player, BOOL toggle) { invoke<Void>(0xA7C511FA1C5BDA38, player, toggle); } // 0xA7C511FA1C5BDA38
}

namespace PLAYER
{
	static Ped GET_PLAYER_PED(Player player) { return invoke<Ped>(0x43A66C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	static Player GET_PLAYER_FROM_SERVER_ID(int serverId) { return invoke<Player>(0x344EA166, serverId); }
...
namespace ENTITY
{
	...
	static float GET_ENTITY_HEADING(Entity entity) { return invoke<float>(0x846BF6291198A71E, entity); } // 0x846BF6291198A71E	
	static float _GET_ENTITY_PHYSICS_HEADING(Entity entity) { return invoke<float>(0xE83D4F9BA2A38914, entity); } // 0xE83D4F9BA2A38914 0x972CC383
...
namespace VEHICLE
{
	...
	static void SET_HEADLIGHT_COLOUR(Vehicle vehicle, int ColourId) { invoke<Void>(0xE41033B25D003A07, vehicle, ColourId); } // 0xE41033B25D003A07
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(int p0, int* argsStruct, int argsStructSize, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argsStructSize, bitset); } // 0x5AE99C571D5BBE5D 0x54763B35
																																								   //static void TRIGGER_SCRIPT_EVENT(bool p0, void* args, int argCount, int bit) { invoke<Void>(0xA40CC53DF8E50837, p0, args, argCount, bit); } // 0xA40CC53DF8E50837 b1103
...
namespace UI
{
	...
	static void _BEGIN_TEXT_COMPONENT(char* componentType) { invoke<Void>(0x80338406F3475E55, componentType); } // 0x80338406F3475E55 
	...
	static void _0x317EBA71D7543F52(char* p0, char* p1, char* p2, char* p3) { invoke<Void>(0x317EBA71D7543F52, p0, p1, p2, p3); } // 0x317EBA71D7543F52
...
namespace GRAPHICS
{
	...
	static BOOL GET_SCREEN_COORD_FROM_WORLD_COORD(float worldX, float worldY, float worldZ, float* screenX, float* screenY) { return invoke<BOOL>(0x34E82F05DF2974F5, worldX, worldY, worldZ, screenX, screenY); } // 0x34E82F05DF2974F5 0x*
